...
#define SCRSHT_CB LGUI(LCTL(LSFT(KC_3)))
#define SCRSHT_FI RGUI(RSFT(KC_3))
#define SLTSHT_CB LGUI(LCTL(LSFT(KC_4)))
#define SLTSHT_FI RGUI(RSFT(KC_4))
#define LOCK_SCRN  LGUI(LCTL(KC_Q))
#define SCRN_SVR   LCTL(LSFT(KC_KB_POWER))

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

  [QWERTY] = LAYOUT_pretty(
    KC_ESC,         KC_F1,          KC_F2,          KC_F3,          KC_F4,           KC_F5,           KC_F6,        KC_F7,          KC_F8,                  KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_PSCR,        KC_SLCK,        KC_PAUS,        TG(COLEMAK),    KC_NO,
  ...
  [COLEMAK] = LAYOUT_pretty(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_NO,
  ...
  [MEDIA] = LAYOUT_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                         KC_TRANSPARENT, LOCK_SCRN,      SCRN_SVR,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [NAVIGATION] = LAYOUT_pretty(
    ...
    KC_TRANSPARENT, KC_NO,          LCTL(KC_SCLN),          SGUI(KC_8),     KC_NO,          KC_NO,                                                                                                                  KC_TRANSPARENT, LGUI(KC_LBRACKET),KC_UP,        RGUI(KC_RBRACKET),KC_TRANSPARENT,KC_NO,
  ...
  [NUMBERS] = LAYOUT_pretty(
    ...
    KC_TRANSPARENT, KC_F9,              KC_F10,              KC_F11,              KC_F12,         KC_TRANSPARENT,                                                                                           KC_SLASH,       KC_7,           KC_8,           KC_9,           KC_MINUS,       KC_NO,
